...
* download FCN V3.8 FULL 百度网盘 链接: https://pan.baidu.com/s/1QBgF2Ca1h3O5JP-er2d6vA 提取码: s986
...
FCN默认加载当前目录下的fcn.conf配置文件,用户也可以手工指定, 注意目前测试帐户 `FCN_0000-FCN_9999`, **测试帐户限速100KB/s，日流量配额150M, 仅限于个人测试使用**[点对点通信成功后无限制]，请用户随机挑选测试帐户，并且设置自己的唯一服务器名，以防止帐户冲突
